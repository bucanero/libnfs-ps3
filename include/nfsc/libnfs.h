 ...
 */
 void nfs_pagecache_invalidate(struct nfs_context *nfs,
                                     struct nfsfh *nfsfh);

/*
 * Initialize the pagecache
 */
  void nfs_pagecache_init(struct nfs_context *nfs,
                                struct nfsfh *nfsfh);
 ...
 */
 int nfs_mount_async(struct nfs_context *nfs, const char *server,
 ...
 */
 int nfs_mount(struct nfs_context *nfs, const char *server,
 ...
 *          data is the error string.
 */
 int nfs_umount_async(struct nfs_context *nfs, nfs_cb cb,
                           void *private_data);
/*
 * Sync nfs umount.
 * For NFSv4 this is a NO-OP.
 ...
 * -errno : The command failed.
 */
 int nfs_umount(struct nfs_context *nfs);
...
struct stat;
 int nfs_stat_async(struct nfs_context *nfs, const char *path, nfs_cb cb,
                          void *private_data);
/*
 * Sync stat(<filename>)
 * Function returns
...
#ifdef WIN32
 int nfs_stat(struct nfs_context *nfs, const char *path,
                    struct __stat64 *st);
#else
 ...
 *          data is the error string.
 */
 int nfs_stat64_async(struct nfs_context *nfs, const char *path,
 ...
 * -errno : The command failed.
 */
 int nfs_stat64(struct nfs_context *nfs, const char *path,
 ...
 *          data is the error string.
 */
 int nfs_lstat64_async(struct nfs_context *nfs, const char *path,
                             nfs_cb cb, void *private_data);
/*
 * Sync stat(<filename>)
 *
 ...
 * -errno : The command failed.
 */
 int nfs_lstat64(struct nfs_context *nfs, const char *path,
                       struct nfs_stat_64 *st);
...
/* This function is deprecated. Use nfs_fstat64_async() instead */
 int nfs_fstat_async(struct nfs_context *nfs, struct nfsfh *nfsfh,
                           nfs_cb cb, void *private_data);
/*
 * Sync fstat(nfsfh *)
 * Function returns
 ...
 *          data is the error string.
 */
 int nfs_fstat64_async(struct nfs_context *nfs, struct nfsfh *nfsfh,
                             nfs_cb cb, void *private_data);
/*
 * Sync fstat(nfsfh *)
 * Function returns
 ...
 * -errno : The command failed.
 */
 int nfs_fstat64(struct nfs_context *nfs, struct nfsfh *nfsfh,
                       struct nfs_stat_64 *st);
 ...
 *          data is the error string.
 */
 int nfs_open_async(struct nfs_context *nfs, const char *path, int flags,
                          nfs_cb cb, void *private_data);
 int nfs_open2_async(struct nfs_context *nfs, const char *path, int flags,
 ...
 * -errno : The command failed.
 */
 int nfs_open(struct nfs_context *nfs, const char *path, int flags,
                    struct nfsfh **nfsfh);
 int nfs_open2(struct nfs_context *nfs, const char *path, int flags,
 ...
 *          data is the error string.
 */
 int nfs_close_async(struct nfs_context *nfs, struct nfsfh *nfsfh,
                           nfs_cb cb, void *private_data);
/*
 * Sync close(nfsfh)
 * Function returns
 ...
 *          data is the error string.
 */
 int nfs_pread_async(struct nfs_context *nfs, struct nfsfh *nfsfh,
 ...
 *          data is the error string.
 */
 int nfs_pwrite_async(struct nfs_context *nfs, struct nfsfh *nfsfh,
 ...
 *          data is the error string.
 */
 int nfs_write_async(struct nfs_context *nfs, struct nfsfh *nfsfh,
 ...
 *          data is the error string.
 */
 int nfs_lseek_async(struct nfs_context *nfs, struct nfsfh *nfsfh,
...
enum nfs4_lock_op {
 ...
 int nfs_lockf_async(struct nfs_context *nfs, struct nfsfh *nfsfh,
 ...
 * -errno : An error occured.
 */
 int nfs_lockf(struct nfs_context *nfs, struct nfsfh *nfsfh,
                     enum nfs4_lock_op op, uint64_t count);
...
struct nfs4_flock {
 ...
 int nfs_fcntl_async(struct nfs_context *nfs, struct nfsfh *nfsfh,
 ...
 * -errno : An error occured.
 */
 int nfs_fcntl(struct nfs_context *nfs, struct nfsfh *nfsfh,
                     enum nfs4_fcntl_op cmd, void *arg);
 ...
 *          data is the error string.
 */
 int nfs_fsync_async(struct nfs_context *nfs, struct nfsfh *nfsfh,
                           nfs_cb cb, void *private_data);
/*
 * Sync fsync()
 * Function returns
 ...
 *          data is the error string.
 */
 int nfs_truncate_async(struct nfs_context *nfs, const char *path,
 ...
 *          data is the error string.
 */
 int nfs_ftruncate_async(struct nfs_context *nfs, struct nfsfh *nfsfh,
                               uint64_t length, nfs_cb cb, void *private_data);
/*
 * Sync ftruncate()
 * Function returns
 ...
 *          data is the error string.
 */
 int nfs_mkdir_async(struct nfs_context *nfs, const char *path,
                           nfs_cb cb, void *private_data);
/*
 * Sync mkdir()
 * Function returns
 ...
 *          data is the error string.
 */
 int nfs_mkdir2_async(struct nfs_context *nfs, const char *path,
                            int mode, nfs_cb cb, void *private_data);
/*
 * Sync mkdir2()
 * Function returns
 ...
 *          data is the error string.
 */
 int nfs_rmdir_async(struct nfs_context *nfs, const char *path,
                           nfs_cb cb, void *private_data);
/*
 * Sync rmdir()
 * Function returns
 ...
 *          data is the error string.
 */
 int nfs_creat_async(struct nfs_context *nfs, const char *path, int mode,
                           nfs_cb cb, void *private_data);
/*
 * Sync creat()
 * Function returns
 ...
 * -errno : An error occured.
 */
 int nfs_creat(struct nfs_context *nfs, const char *path, int mode,
                     struct nfsfh **nfsfh);
 ...
 * -errno : An error occured.
 */
 int nfs_create(struct nfs_context *nfs, const char *path, int flags,
                      int mode, struct nfsfh **nfsfh);
 ...
 *          data is the error string.
 */
 int nfs_mknod_async(struct nfs_context *nfs, const char *path, int mode,
 ...
 * -errno : An error occured.
 */
 int nfs_mknod(struct nfs_context *nfs, const char *path, int mode,
                     int dev);
 ...
 *          data is the error string.
 */
 int nfs_unlink_async(struct nfs_context *nfs, const char *path,
                            nfs_cb cb, void *private_data);
/*
 * Sync unlink()
 * Function returns
 ...
 *          data is the error string.
 */
 int nfs_opendir_async(struct nfs_context *nfs, const char *path,
                             nfs_cb cb, void *private_data);
/*
 * Sync opendir()
 * Function returns
 ...
 * -errno : An error occured.
 */
 int nfs_opendir(struct nfs_context *nfs, const char *path,
 ...
 */
 struct nfsdirent *nfs_readdir(struct nfs_context *nfs,
                                     struct nfsdir *nfsdir);
 ...
 */
 void nfs_seekdir(struct nfs_context *nfs, struct nfsdir *nfsdir,
                        long loc);
 ...
 * This function will never block so there is no need for an async version.
 */
 long nfs_telldir(struct nfs_context *nfs, struct nfsdir *nfsdir);
 ...
 * This function will never block so there is no need for an async version.
 */
 void nfs_rewinddir(struct nfs_context *nfs, struct nfsdir *nfsdir);
 ...
 *          data is the error string.
 */
 int nfs_chdir_async(struct nfs_context *nfs, const char *path,
                           nfs_cb cb, void *private_data);
/*
 * Sync chdir(<path>)
 * Function returns
 ...
 */
struct statvfs;
 int nfs_statvfs_async(struct nfs_context *nfs, const char *path,
                             nfs_cb cb, void *private_data);
/*
 ...
 * -errno : The command failed.
 */
 int nfs_statvfs(struct nfs_context *nfs, const char *path,
                       struct statvfs *svfs);
/*
 ...
 *          data is the error string.
 */
 int nfs_statvfs64_async(struct nfs_context *nfs, const char *path,
                               nfs_cb cb, void *private_data);
/*
 ...
 * -errno : The command failed.
 */
 int nfs_statvfs64(struct nfs_context *nfs, const char *path,
 ...
 *          data is the error string.
 */
 int nfs_readlink_async(struct nfs_context *nfs, const char *path,
                              nfs_cb cb, void *private_data);
/*
 * Sync readlink(<name>)
 * Function returns
 ...
 * -errno : The command failed.
 */
 int nfs_readlink(struct nfs_context *nfs, const char *path, char *buf,
                        int bufsize);
 ...
 */
 int nfs_readlink2(struct nfs_context *nfs, const char *path,
                         char **bufptr);
 ...
 *          data is the error string.
 */
 int nfs_chmod_async(struct nfs_context *nfs, const char *path, int mode,
                           nfs_cb cb, void *private_data);
/*
 * Sync chmod(<name>)
 * Function returns
 ...
 *          data is the error string.
 */
 int nfs_lchmod_async(struct nfs_context *nfs, const char *path,
                            int mode, nfs_cb cb, void *private_data);
/*
 * Sync chmod(<name>)
 *
 ...
 *          data is the error string.
 */
 int nfs_fchmod_async(struct nfs_context *nfs, struct nfsfh *nfsfh,
                            int mode, nfs_cb cb, void *private_data);
/*
 * Sync fchmod(<handle>)
 * Function returns
 ...
 *          data is the error string.
 */
 int nfs_chown_async(struct nfs_context *nfs, const char *path, int uid,
 ...
 * -errno : The command failed.
 */
 int nfs_chown(struct nfs_context *nfs, const char *path, int uid,
                     int gid);
/*
 * Async chown(<name>)
 *
 ...
 *          data is the error string.
 */
 int nfs_lchown_async(struct nfs_context *nfs, const char *path, int uid,
                            int gid, nfs_cb cb, void *private_data);
/*
 * Sync chown(<name>)
 *
 ...
 * -errno : The command failed.
 */
 int nfs_lchown(struct nfs_context *nfs, const char *path, int uid,
                      int gid);
 ...
 *          data is the error string.
 */
 int nfs_fchown_async(struct nfs_context *nfs, struct nfsfh *nfsfh,
 ...
 * -errno : The command failed.
 */
 int nfs_fchown(struct nfs_context *nfs, struct nfsfh *nfsfh, int uid,
                      int gid);
 ...
 *          data is the error string.
 */
 int nfs_utimes_async(struct nfs_context *nfs, const char *path,
 ...
 * -errno : The command failed.
 */
 int nfs_utimes(struct nfs_context *nfs, const char *path,
 ...
 *          data is the error string.
 */
 int nfs_lutimes_async(struct nfs_context *nfs, const char *path,
                             struct timeval *times, nfs_cb cb,
                             void *private_data);
/*
 * Sync utimes(<path>)
 ...
 * -errno : The command failed.
 */
 int nfs_lutimes(struct nfs_context *nfs, const char *path,
                       struct timeval *times);
 ...
 */
struct utimbuf;
 int nfs_utime_async(struct nfs_context *nfs, const char *path,
 ...
 * -errno : The command failed.
 */
 int nfs_utime(struct nfs_context *nfs, const char *path,
 ...
 *          data is the error string.
 */
 int nfs_access_async(struct nfs_context *nfs, const char *path,
                            int mode, nfs_cb cb, void *private_data);
/*
 * Sync access(<path>)
 * Function returns
 ...
 *          data is the error string.
 */
 int nfs_access2_async(struct nfs_context *nfs, const char *path,
                             nfs_cb cb, void *private_data);
/*
 * Sync access(<path>)
 * Function returns
 ...
 *          data is the error string.
 */
 int nfs_symlink_async(struct nfs_context *nfs, const char *target,
 ...
 * -errno : The command failed.
 */
 int nfs_symlink(struct nfs_context *nfs, const char *target,
                       const char *linkname);
 ...
 *          data is the error string.
 */
 int nfs_rename_async(struct nfs_context *nfs, const char *oldpath,
 ...
 * -errno : The command failed.
 */
 int nfs_rename(struct nfs_context *nfs, const char *oldpath,
                      const char *newpath);
 ...
 *          data is the error string.
 */
 int nfs_link_async(struct nfs_context *nfs, const char *oldpath,
                          const char *newpath, nfs_cb cb, void *private_data);
/*
 ...
 * -errno : The command failed.
 */
 int nfs_link(struct nfs_context *nfs, const char *oldpath,
                    const char *newpath);
 ...
 *          data is the error string.
 */
 int mount_getexports_async(struct rpc_context *rpc, const char *server,
 ...
 */
 void nfs4_set_client_name(struct nfs_context *nfs, const char *id);

/*
 * Set the client verifier for NFSv4.
 * This an 8 byte array of random data.
 */
 void nfs4_set_verifier(struct nfs_context *nfs, const char *verifier);
